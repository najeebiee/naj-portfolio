...
export const visualGalleries: ExhibitionGallery[] = [
  {
    ...
    logo: {
      ...
      naturalHeight: 861,
      height: 861,
      layout: { x: 1247, y: 410, width: 520, rotation: -3, zIndex: 2 },
    },
    works: [
      {
        id: "drift-cup",
        title: "First Drift Poster",
        role: "hero",
        ...
        layout: { x: 2100, y: 550, rotation: 0, zIndex: 3 },
      },
      {
        id: "drift-better",
        ...
        tools: ["Figma", "Photoshop"],
        layout: { x: 2327, y: 1308, rotation: -5, zIndex: 2 },
      },
      {
        id: "drift-dubai",
        title: "Dubai Cookie Launch",
        ...
        tools: ["Figma"],
        layout: { x: 2530, y: 3200, rotation: 2, zIndex: 4 },
      },
      {
        id: "drift-menu",
        title: "Classic Menu",
        ...
        medium: "Menu design",
        tools: ["Figma"],
        layout: { x: 1930, y: 2180, rotation: 0, zIndex: 1 },
      },
      {
        id: "drift-try",
        title: "Try Now",
        ...
        tools: ["Figma"],
        layout: { x: 2590, y: 2600, rotation: 6, zIndex: 1 },
      },
      {
        id: "drift-visit",
        title: "Visit Drift",
        ...
        tools: ["Figma", "Photoshop"],
        layout: { x: 2776, y: 1220, rotation: -2, zIndex: 4 },
      },
      {
        id: "drift-promo",
        ...
        tools: ["Figma"],
        layout: { x: 346, y: 1820, rotation: -2, zIndex: 3 },
      },
      {
        id: "drift-after",
        title: "After Caffeine",
        role: "mini",
        ...
        tools: ["Figma"],
        layout: { x: 1526, y: 1620, rotation: 0, zIndex: 3 },
      },
      {
        id: "drift-tear",
        ...
        tools: ["Figma", "Photoshop"],
        layout: { x: 2720, y: 655, rotation: -4, zIndex: 2 },
      },
      {
        id: "drift-april",
        title: "April 09",
        role: "hero",
        src: "/visuals/drift/artworks/april.webp",
        alt: "Drift April campaign artwork.",
        naturalWidth: 1080,
        naturalHeight: 1350,
        year: "2026",
        medium: "Campaign visual",
        tools: ["Figma"],
        layout: { x: 838, y: 1327, rotation: 0, zIndex: 1 },
      },
      {
        id: "drift-inknovation",
        title: "Inknovation X Drift",
        role: "mini",
        src: "/visuals/drift/artworks/inknovation.webp",
        alt: "Drift inknovation campaign artwork.",
        naturalWidth: 1080,
        naturalHeight: 1350,
        year: "2026",
        medium: "Campaign visual",
        tools: ["Figma"],
        layout: { x: 575, y: 2370, rotation: 2, zIndex: 1 },
      },
      {
        id: "drift-map",
        title: "Map for Guide",
        role: "mini",
        src: "/visuals/drift/artworks/map.webp",
        alt: "Drift map-themed campaign artwork.",
        naturalWidth: 1080,
        naturalHeight: 1350,
        year: "2026",
        medium: "Campaign visual",
        tools: ["Figma"],
        layout: { x: 1590, y: 3490, rotation: 0, zIndex: 1 },
      },
      {
        id: "drift-off",
        title: "Drift Sale",
        role: "support",
        src: "/visuals/drift/artworks/off.webp",
        alt: "Drift off campaign artwork.",
        naturalWidth: 1080,
        naturalHeight: 1350,
        year: "2026",
        medium: "Campaign visual",
        tools: ["Figma"],
        layout: { x: 1490, y: 2920, rotation: -3, zIndex: 1 },
      },
      {
        id: "drift-one",
        title: "One Stop Four Vibes",
        role: "support",
        src: "/visuals/drift/artworks/one.webp",
        alt: "Drift one campaign artwork.",
        naturalWidth: 1080,
        naturalHeight: 1350,
        year: "2026",
        medium: "Campaign visual",
        tools: ["Figma"],
        layout: { x: 945, y: 2178, rotation: 1, zIndex: 1 },
      },
      {
        id: "drift-stop",
        title: "One Stop Four Vibes 2",
        role: "mini",
        src: "/visuals/drift/artworks/stop.webp",
        alt: "Drift stop campaign artwork.",
        naturalWidth: 1080,
        naturalHeight: 1350,
        year: "2026",
        medium: "Campaign visual",
        tools: ["Figma"],
        layout: { x: 475, y: 1435, rotation: 3, zIndex: 1 },
      },
      {
        id: "drift-tambay",
        title: "Where to Tambay",
        role: "mini",
        src: "/visuals/drift/artworks/tambay.webp",
        alt: "Drift tambay campaign artwork.",
        naturalWidth: 1080,
        naturalHeight: 1350,
        year: "2026",
        medium: "Campaign visual",
        tools: ["Figma"],
        layout: { x: 2200, y: 2940, rotation: 4, zIndex: 1 },
      },
      {
        id: "drift-there",
        title: "We've Been There",
        role: "support",
        src: "/visuals/drift/artworks/there.webp",
        alt: "Drift there campaign artwork.",
        naturalWidth: 1080,
        naturalHeight: 1350,
        year: "2026",
        medium: "Campaign visual",
        tools: ["Figma"],
        layout: { x: 2040, y: 3375, rotation: 0, zIndex: 1 },
      },
    ],
  },
  {
    ...
    logo: {
      ...
      naturalHeight: 320,
      height: 320,
      layout: { x: 1720, y: 340, width: 560, rotation: 0, zIndex: 2 },
    },
    works: [
      {
        id: "gutguard-cover",
        ...
        tools: ["Figma"],
        layout: { x: 1300, y: 1600, rotation: 0, zIndex: 2 },
      },
      {
        id: "gutguard-synbiotic",
        title: "Healthy Gut Synbiotic",
        role: "hero",
        ...
        tools: ["Figma", "Photoshop"],
        layout: { x: 2300, y: 2200, rotation: 0, zIndex: 3 },
      },
      {
        id: "gutguard-bottle",
        title: "Bottle Poster",
        ...
        tools: ["Figma", "Photoshop"],
        layout: { x: 1900, y: 2500, rotation: -1, zIndex: 3 },
      },
      {
        id: "gutguard-gerd",
        title: "GERD Solution",
        ...
        tools: ["Figma"],
        layout: { x: 1490, y: 965, rotation: 2, zIndex: 2 },
      },
      {
        id: "gutguard-skin",
        title: "Skin Benefits",
        ...
        tools: ["Figma"],
        layout: { x: 910, y: 420, rotation: 0, zIndex: 3 },
      },
      {
        id: "gutguard-support",
        title: "Diarrhea Again",
        role: "support",
        ...
        medium: "Social card",
        tools: ["Figma"],
        layout: { x: 390, y: 865, rotation: -2, zIndex: 1 },
      },
      {
        id: "gutguard-haggard",
        title: "Haggard",
        role: "support",
        src: "/visuals/gutguard/artworks/haggard.webp",
        alt: "GutGuard haggard wellness campaign artwork.",
        naturalWidth: 1150,
        naturalHeight: 920,
        year: "2026",
        medium: "Benefit creative",
        tools: ["Figma"],
        layout: { x: 2850, y: 2600, rotation: -1, zIndex: 3 },
      },
    ],
  },
  {
    ...
    logo: {
      ...
      naturalHeight: 32,
      height: 32,
      layout: { x: 1300, y: 330, width: 440, rotation: 0, zIndex: 2 },
    },
    works: [
      {
        id: "naj-above",
        ...
        tools: ["Figma", "Photoshop"],
        layout: { x: 1160, y: 650, rotation: 0, zIndex: 3 },
      },
      {
        id: "naj-matrix",
        title: "Matrix",
        ...
        tools: ["Figma"],
        layout: { x: 650, y: 650, rotation: 3, zIndex: 2 },
      },
      {
        id: "naj-design",
        title: "Design Note",
        ...
        medium: "Design study",
        tools: ["Figma"],
        layout: { x: 650, y: 1250, rotation: 0, zIndex: 1 },
      },
      {
        id: "naj-clinics",
        title: "Clinics",
        ...
        medium: "Poster design",
        tools: ["Figma"],
        layout: { x: 1890, y: 790, rotation: 1, zIndex: 2 },
      },
      {
        id: "naj-announcement",
        title: "Announcement",
        ...
        tools: ["Figma"],
        layout: { x: 1900, y: 1400, rotation: 0, zIndex: 1 },
      },
      {
        id: "naj-cupid",
        title: "Cupid",
        ...
        medium: "Poster study",
        tools: ["Figma"],
        layout: { x: 830, y: 1700, rotation: -2, zIndex: 3 },
      },
      {
        id: "naj-davao",
        title: "Davao",
        role: "support",
        src: "/visuals/naj/artworks/davao.webp",
        alt: "NAJ Davao poster study.",
        naturalWidth: 540,
        naturalHeight: 720,
        year: "2026",
        medium: "Poster study",
        tools: ["Figma"],
        layout: { x: 1300, y: 1450, rotation: 0, zIndex: 3 },
      },
    ],
  },
];
